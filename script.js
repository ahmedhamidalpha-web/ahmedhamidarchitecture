...
/* Renders the bold "Let's build something great" band. Call from any page
   with a mount div: <div id="cta-band"></div> */
function renderCtaBand(){
  const mount = document.getElementById("cta-band");
  if(!mount) return;
  mount.innerHTML = `
    <section><div class="cta-band reveal in">
      <div>
        <h2>Let's build something great.</h2>
        <p>Send your plot and your idea — we'll take it from concept to construction drawings.</p>
      </div>
